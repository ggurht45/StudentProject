...
//        DebugHelper.runVectorDebugTests();
        ...
        realTarget = getHandFromString(LeapUIApp.TargetsPath + "2017-06-12 12-13-58.hand"); //--normal. facing up.
...
//        loadedHand = getHandFromString("dataOutput/1/typeA_2017-06-30 08-09-16.hand"); //--facing downwards, yaw 45* to the right.  pointing -z direction
        loadedHand = getHandFromString(LeapUIApp.TargetsPath + "2017-06-12 12-21-01.hand"); //--to the right
